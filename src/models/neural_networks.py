...
from core.constants import (
    DEFAULT_NUM_CLASSES, DEFAULT_FC_HIDDEN_DIMS, DEFAULT_FC_DROPOUT,
    DEFAULT_CNN_DROPOUT, DEFAULT_TRANSFORMER_HEADS, DEFAULT_TRANSFORMER_FF_DIM
)
...
class FC_model(BaseModel):
    ...
    def __init__(self, input_dim: int = 16796, hidden_dims: List[int] = None, output_dim: int = DEFAULT_NUM_CLASSES, dropout: float = DEFAULT_FC_DROPOUT):
...
class CNN_model(BaseModel):
    ...
    def __init__(self, input_channels: int = 1, num_classes: int = DEFAULT_NUM_CLASSES, dropout: float = DEFAULT_CNN_DROPOUT):
