...
class DatasetFactory:
    ...
    def _auto_detect_dataset(root_dir: str) -> str:
        ...
        gtzan_count = sum(1 for genre in gtzan_genres if os.path.exists(os.path.join(root_dir, genre)))
    ...
    def validate_dataset(root_dir: str, dataset_type: str) -> bool:
        ...
        try:
            ...
            return dataset.validate_structure() if hasattr(dataset, 'validate_structure') else True
