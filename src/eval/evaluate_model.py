    ...
    with open(metrics_file, "w") as f:
        ...
        f.write(
            classification_report(
                results["y_true"], results["y_pred"], target_names=class_names, zero_division=0
            )
        )
...
def main():
    ...
    plot_confusion_matrix(
        results["confusion_matrix"], class_names, os.path.join(output_dir, "confusion_matrix.png")
    )
