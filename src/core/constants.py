...
# RNN/LSTM/GRU Defaults
DEFAULT_RNN_HIDDEN_SIZE = 128
DEFAULT_RNN_NUM_LAYERS = 2
DEFAULT_RNN_DROPOUT = 0.3

DEFAULT_LSTM_HIDDEN_SIZE = 128
DEFAULT_LSTM_NUM_LAYERS = 2
DEFAULT_LSTM_DROPOUT = 0.3

DEFAULT_GRU_HIDDEN_SIZE = 128
DEFAULT_GRU_NUM_LAYERS = 2
DEFAULT_GRU_DROPOUT = 0.3

# xLSTM Defaults
DEFAULT_XLSTM_HIDDEN_SIZE = 256
DEFAULT_XLSTM_NUM_LAYERS = 2

# Transformer additional defaults
DEFAULT_TRANSFORMER_HIDDEN_SIZE = 128
