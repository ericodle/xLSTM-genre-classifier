...
class TestAudioPreprocessing:
    ...
    def sample_features(self):
        ...
        return np.random.randn(
            20, 100, 13
        )  # 20 samples, 100 time steps, 13 MFCC coefficients
    ...
    def test_feature_normalization(self, sample_features):
        ...
        normalized_features = preprocessor.normalize_features(
            sample_features, method="zscore"
        )
    ...
    def test_class_balancing(self, sample_features, sample_labels):
        ...
        balanced_features, balanced_labels = preprocessor.balance_classes(
            imbalanced_features, imbalanced_labels
        )
        ...
        unique_labels_balanced, counts_balanced = np.unique(
            balanced_labels, return_counts=True
        )
        ...
        balanced_features_2, balanced_labels_2 = preprocessor.balance_classes(
